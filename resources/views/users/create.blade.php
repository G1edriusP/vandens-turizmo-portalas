...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Vartotojo kūrimas') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('vartotojai_sukurti') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href='{{ route('vartotojai') }}' class="btn btn-secondary mr-3">Atgal</a>
                            </div>
                        </div>
                    </form>
                </div>
